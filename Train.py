...
output = "output/"+sys.argv[1]+"/result/"
models="output/"+sys.argv[1]+"/model/"

# create a file folder for saving output files
if not os.path.exists(output):
    os.mkdir(output)
    print('{0} create successful!'.format(output))
else:
...
def main():
    pos_file = "example/"+sys.argv[1]+"_pos_train.fa"
    neg_file = "example/"+sys.argv[1]+"_neg_train.fa"
